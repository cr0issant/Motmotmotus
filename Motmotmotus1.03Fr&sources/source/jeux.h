	...
	while(z==0)
	{
		...
		if ( Stylus.Newpress ) 
		{
			...
			if ( colonnes == (nbre_lettres*2) )
			{
				...
				/*
				PA_InitText(1, 2);
				PA_OutputText(1,0,0,"%d%d%d%d%d%d-%d%d%d%d%d%d-%d%d%d%d%d%d-%d%d%d%d%d%d",nbre_lettre_mot_du_joueur[0],nbre_lettre_mot_du_joueur[1],nbre_lettre_mot_du_joueur[2],nbre_lettre_mot_du_joueur[3],nbre_lettre_mot_du_joueur[4],nbre_lettre_mot_du_joueur[5],nbre_lettre_solution[0],nbre_lettre_solution[1],nbre_lettre_solution[2],nbre_lettre_solution[3],nbre_lettre_solution[4],nbre_lettre_solution[5],lettre_valide_rouge[0],lettre_valide_rouge[1],lettre_valide_rouge[2],lettre_valide_rouge[3],lettre_valide_rouge[4],lettre_valide_rouge[5],position[0],position[1],position[2],position[3],position[4],position[5]);
				*/
				...
				for (i=0;i<nbre_lettres;i++)
				{
						...
						(( gagne == nbre_lettres )&&( mode_de_jeu == 3 ))   )
					{
						...
						{ 
							...
							PA_SetSpriteXY(0, 4, 16*4+4, 104-16*5 );
							PA_SetSpriteXY(0, 5, 16*8+4, 104-16*5 );
							for (i=0;i<nbre_lettres;i++)
							{
